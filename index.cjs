...
var translate_default = (theme2) => (str) => {
  let x;
  let n2 = "";
  if (str[0] === "-") {
    n2 = "-";
  ...
  switch (i.length) {
    case 1:
      switch (i[0]) {
        ...
        case "truncate":
          ...
          break;
        case "transition":
          out[`${i[0]}-property`] = "background-color, border-color, color, fill, stroke, opacity, box-shadow, transform";
          break;
        case "resize":
          out[i[0]] = "both";
          break;
        case "rounded":
          out["border-radius"] = theme2.borderRadius["default"];
          break;
        case "clearfix":
          out["::after"] = {
            content: '""',
      ...
      switch (i[0]) {
        ...
        case "flex":
          switch (i[1]) {
            ...
            case "initial":
            case "none":
              out["flex"] = theme2.flex[i[1]];
              break;
            case "grow":
              out[`flex-grow`] = theme2.flexGrow["default"];
              break;
            case "shrink":
              out[`flex-shrink`] = theme2.flexShrink["default"];
              break;
          }
          break;
        case "items":
        ...
        case "row":
          ...
          break;
        case "w":
          out["width"] = theme2.width[i[1]];
          break;
        case "h":
          out["height"] = theme2.height[i[1]];
          break;
        case "text":
          switch (i[1]) {
            case "left":
            ...
            case "current":
              ...
              break;
            default:
              if (x = theme2.fontSize[i[1]])
                out["font-size"] = x;
              else
                out["color"] = theme2.colors[i[1]];
              break;
          }
          break;
        case "subpixel":
        ...
        case "bg":
          switch (i[1]) {
            ...
            case "current":
              ...
              break;
            default:
              out["background-color"] = theme2.colors[i[1]];
              break;
          }
          break;
        case "border":
          switch (i[1]) {
            ...
            case "b":
            case "l":
              out = edgesHelper(["border", i[1], "width"], theme2.borderWidth["default"]);
              break;
            case "solid":
            case "dashed":
            case "dotted":
            ...
            case "current":
              ...
              break;
            default:
              if (x = theme2.borderWidth[i[1]])
                out[i[0] + "-width"] = x;
              else
                out[i[0] + "-color"] = theme2.colors[i[1]];
              break;
          }
          break;
        case "shadow":
          out["box-shadow"] = theme2.boxShadow[i[1]];
          break;
        case "opacity":
          out["opacity"] = theme2.opacity[i[1]];
          break;
        case "transition":
          out[`transition-property`] = theme2.transitionProperty[i[1]];
          break;
        case "ease":
          out["transition-timing-function"] = theme2.transitionTimingFunction[i[1]];
          break;
        case "appearance":
          if (i[1] === "none")
            out[i[0]] = i[1];
        ...
        case "resize":
          ...
          break;
        case "fill":
          i[1] === "current" && (out["fill"] = theme2.fill[i[1]]);
          break;
        case "stroke":
          i[1] === "current" ? out["stroke"] = theme2.stroke["current"] : out["stroke-width"] = theme2.strokeWidth[i[1]];
          break;
        case "sr":
          i[1] === "only" && (out = {
            width: "1px",
        ...
        case "scrolling":
          ...
          break;
        case "z":
          out["z-index"] = theme2.zIndex[i[1]];
          break;
        case "gap":
          out["gap"] = theme2.gap[i[1]];
          break;
        case "p":
          out["padding"] = theme2.padding[i[1]];
          break;
        case "py":
        case "px":
        case "pt":
        ...
        case "pb":
        case "pl":
          out = edgesHelper(["padding", i[0][1]], theme2.padding[i[1]]);
          break;
        case "m":
          out["margin"] = `${n2}${theme2.margin[i[1]]}`;
          break;
        case "my":
        case "mx":
        case "mt":
        ...
        case "mb":
        case "ml":
          out = edgesHelper(["margin", i[0][1]], `${n2}${theme2.margin[i[1]]}`);
          break;
        case "font":
          if (x = theme2.fontFamily[i[1]])
            out["font-family"] = x;
          if (x = theme2.fontWeight[i[1]])
            out["font-weight"] = x;
          break;
        case "tracking":
          out["letter-spacing"] = theme2.letterSpacing[i[1]];
          break;
        case "leading":
          out["line-height"] = theme2.lineHeight[i[1]];
          break;
        case "align":
        ...
        case "rounded":
          switch (i[1]) {
            ...
            case "bl":
            case "br":
              out = cornersHelper(["border", i[1], "radius"], theme2.borderRadius["default"]);
              break;
            default:
              out["border-radius"] = theme2.borderRadius[i[1]];
              break;
          }
          break;
        case "duration":
          out[`transition-${i[0]}`] = `${theme2.transitionDuration[i[1]]}`;
          break;
        case "delay":
          out["transition-delay"] = `${theme2.transitionDelay[i[1]]}`;
          break;
        case "scale":
          out["transform"] = `scale(${theme2.scale[i[1]]})`;
          break;
        case "rotate":
          out["transform"] = `rotate(${n2 ? "-" : ""}${theme2.rotate[i[1]]})`;
          break;
        case "origin":
        ...
        case "divide":
          switch (i[1]) {
            ...
            case "y":
              out["selectors"] = {
                "& > * + *": {
                  [`border-${i[1] === "x" ? "left" : "top"}-width`]: theme2.divideWidth["default"]
                }
              };
              break;
            default:
              out["selectors"] = {
                "& > * + *": (x = theme2.colors[i[1]]) ? {
                  [`border-color`]: theme2.colors[i[1]]
                } : {"border-style": i[1]}
              };
              break;
          }
    ...
    case 3:
      switch (i[0]) {
        case "divide":
          switch (i[1]) {
            ...
            case "y":
              out["selectors"] = {
                "& > * + *": {
                  [`border-${i[1] === "x" ? "left" : "top"}-width`]: theme2.divideWidth[i[2]]
                }
              };
              break;
            default:
              out["selectors"] = {
                "& > * + *": {
                  [`border-color`]: theme2.colors[i[1]][i[2]]
                }
              };
              break;
          }
          break;
        case "placeholder":
          out[`::${i[0]}`] = {color: theme2.placeholderColor[i[1]][i[2]]};
          break;
        case "table":
        ...
        case "min":
          switch (i[1]) {
            case "w":
              out["min-width"] = theme2.minWidth[i[2]];
              break;
            case "h":
              out["min-height"] = theme2.minHeight[i[2]];
              break;
          }
          break;
        case "max":
          switch (i[1]) {
            case "w":
              out["max-width"] = theme2.maxWidth[i[2]];
              break;
            case "h":
              out["max-height"] = theme2.maxHeight[i[2]];
              break;
          }
          break;
        case "whitespace":
        ...
        case "bg":
          switch (i[1]) {
            ...
            case "right":
              ...
              break;
            default:
              theme2.colors[i[1]] && (x = theme2.colors[i[1]][i[2]]) && (out["background-color"] = x);
              break;
          }
          break;
        case "ease":
        ...
        case "col":
          switch (i[1]) {
            ...
            case "end":
              ...
              break;
            case "gap":
              out["column-gap"] = theme2.spacing[i[2]];
              break;
          }
          break;
        case "row":
        ...
        case "rounded":
          switch (i[1]) {
            ...
            case "bl":
            case "br":
              out = cornersHelper(["border", i[1], "radius"], theme2.borderRadius[i[2]]);
              break;
          }
          break;
        case "border":
          switch (i[1]) {
            ...
            case "b":
            case "l":
              out = edgesHelper(["border", i[1], "width"], theme2.borderWidth[i[2]]);
              break;
            default:
              theme2.colors[i[1]] && (x = theme2.colors[i[1]][i[2]]) && (out[`border-color`] = x);
              break;
          }
          break;
        case "scale":
          out["transform"] = `scale${i[1].toUpperCase()}(${theme2.scale[i[2]]})`;
          break;
        case "translate":
          out["transform"] = `${i[0]}${i[1].toUpperCase()}(${n2}${theme2.spacing[i[2]]})`;
          break;
        case "skew":
          out["transform"] = `${i[0]}${i[1].toUpperCase()}(${n2}${theme2.skew[i[2]]})`;
          break;
        case "pointer":
          if (i[1] === "events")
          ...
          break;
        case "text":
          theme2.colors[i[1]] && (x = theme2.colors[i[1]][i[2]]) && (out["color"] = x);
          break;
        case "align":
        ...
        case "space":
          out["selectors"] = {
            "& > * + *": {
              [`margin-${i[1] === "x" ? "left" : "top"}`]: `${n2}${theme2.margin[i[2]]}`
            }
          };
          break;
      }
    ...
    case 4:
      switch (i[0]) {
        ...
        case "max":
          if (i[1] + i[2] === "wscreen")
            out["max-width"] = theme2.maxWidth[`screen-${i[3]}`];
          break;
      }
      break;
  }
...
const configure = (theme2) => merge_default(theme_default(merge_default(globals, theme2)), theme2);
const themed = (theme2 = {}) => {
  const processWithTheme = process2(configure(theme2));
